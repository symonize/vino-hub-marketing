...
const VariableProximity = forwardRef<HTMLSpanElement, VariableProximityProps>((props, ref) => {
  const {
    label,
    // Instrument Sans has a `wdth` axis (75–100). Default: collapse to 75,
    // expand to 100 near the cursor.
    fromFontVariationSettings = "'wdth' 75",
    toFontVariationSettings = "'wdth' 100",
    containerRef,
    radius = 80,
    falloff = "gaussian",
    className = "",
