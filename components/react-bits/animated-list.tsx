...
export interface AnimatedListProps {
  ...
  /** ClassName applied to each item wrapper (replaces default card chrome) */
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        itemClassName ??
          "rounded-2xl bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-neutral-800",
